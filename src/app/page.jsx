      ...
      <section className="flex gap-10 px-16 py-10">
        ...
        <div className="w-1/2">
          <div className="h-40  flex justify-center ">
            <img className="border rounded-full w-1/4 h-full " alt="err" />
          </div>
          ...
          <div>
            <p className="px-10">
              We don't believe in selling packages that bring us the most
              profit. Our prime focus is providing the customer with what he or
              she wants. With this highly customer centric approach,we
              acknowledge that all traveller requirements are different and
              unique. You can be rest assured about getting a highly
              personalized experience from our travel experts as they are ready
