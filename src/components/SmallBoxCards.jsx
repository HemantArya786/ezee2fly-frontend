...
function SmallBoxCards({ cardDataDetail }) {
  return (
    <div className="flex flex-wrap gap-x-6 gap-y-10 justify-center">
      {cardDataDetail.map((item, index) => (
        <div
          key={index}
          className="w-[calc(33%-1.5rem)] bg-white shadow-[0px_0px_15px_rgba(0,0,0,0.09)] p-9 space-y-3 relative overflow-hidden rounded-lg transform transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg"
        >
